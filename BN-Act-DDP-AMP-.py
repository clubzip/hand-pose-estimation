...
class CPM2DPose(nn.Module):
    def __init__(self):
        ...
        self.batnorm1_1 = nn.BatchNorm2d(64)
        self.batnorm1_2 = nn.BatchNorm2d(64)
        ...
        self.batnorm2_1 = nn.BatchNorm2d(128)
        self.batnorm2_2 = nn.BatchNorm2d(128)
        ...
        self.batnorm3_1 = nn.BatchNorm2d(256)
        self.batnorm3_2 = nn.BatchNorm2d(256)
        self.batnorm3_3 = nn.BatchNorm2d(256)
        self.batnorm3_4 = nn.BatchNorm2d(256)
        ...
        self.batnorm4_1 = nn.BatchNorm2d(256)
        self.batnorm4_2 = nn.BatchNorm2d(256)
        self.batnorm4_3 = nn.BatchNorm2d(256)
        ...
        self.batnorm6_1 = nn.BatchNorm2d(128)
        self.batnorm6_2 = nn.BatchNorm2d(128)
        self.batnorm6_3 = nn.BatchNorm2d(128)
        self.batnorm6_4 = nn.BatchNorm2d(128)
        self.batnorm6_5 = nn.BatchNorm2d(128)
        ...
        self.batnorm7_1 = nn.BatchNorm2d(128)
        self.batnorm7_2 = nn.BatchNorm2d(128)
        self.batnorm7_3 = nn.BatchNorm2d(128)
        self.batnorm7_4 = nn.BatchNorm2d(128)
    ...
    def forward(self, x):
        x = self.batnorm1_1(self.conv1_1(x))
        x = self.relu(x)
        x = self.batnorm1_2(self.conv1_2(x))
        x = self.relu(x)
        x = self.maxpool(x)
        x = self.batnorm2_1(self.conv2_1(x))
        x = self.relu(x)
        x = self.batnorm2_2(self.conv2_2(x))
        x = self.relu(x)
        x = self.maxpool(x)
        x = self.batnorm3_1(self.conv3_1(x))
        x = self.relu(x)
        x = self.batnorm3_2(self.conv3_2(x))
        x = self.relu(x)
        x = self.batnorm3_3(self.conv3_3(x))
        x = self.relu(x)
        x = self.batnorm3_4(self.conv3_4(x))
        x = self.relu(x)
        x = self.maxpool(x)
        x = self.relu(self.conv4_1(x))
        x = self.relu(self.conv4_2(x))
        x = self.batnorm4_1(self.conv4_3(x))
        x = self.relu(x)
        x = self.batnorm4_2(self.conv4_4(x))
        x = self.relu(x)
        x = self.batnorm4_3(self.conv4_5(x))
        x = self.relu(x)
        ...
        x = self.batnorm6_1(self.conv6_1(x))
        x = self.relu(x)
        x = self.batnorm6_2(self.conv6_2(x))
        x = self.relu(x)
        x = self.batnorm6_3(self.conv6_3(x))
        x = self.relu(x)
        x = self.batnorm6_4(self.conv6_4(x))
        x = self.relu(x)
        x = self.batnorm6_5(self.conv6_5(x))
        x = self.relu(x)
        x = self.relu(self.conv6_6(x))
        scoremap = self.conv6_7(x)
        x = torch.cat([scoremap, encoding], 1)
        x = self.batnorm7_1(self.conv7_1(x))
        x = self.relu(x)
        x = self.batnorm7_2(self.conv7_2(x))
        x = self.relu(x)
        x = self.batnorm7_3(self.conv7_3(x))
        x = self.relu(x)
        x = self.relu(self.conv7_4(x))
        x = self.dropout(x)
        x = self.batnorm7_4(self.conv7_5(x))
        x = self.relu(x)
